...
This code of conduct applies to all spaces related to the `developer-guide`
...
reported to the community leaders responsible for enforcement (see `authors` in
the `pyproject.toml` file for email addresses), or to LASP HR at
`hr@lasp.colorado.edu`. All complaints will be reviewed and investigated
promptly and fairly.
